...
print("AD and CF intersect at : \n",line_intersect(A,D,C,F))
print("BE and CF intersect at : \n",line_intersect(B,E,C,F))
print("AD and BE intersect at : \n",line_intersect(A,D,B,E))